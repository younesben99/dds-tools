...
if (!is_admin()) {
    ...
    // Check if $digiflow_settings_options is an array
    if (is_array($digiflow_settings_options)) {
        ...
        // Handle the case where digiflow_settings_option_name does not exist or is not an array
        // Possibly log an error or set a default configuration
    }
}
?>

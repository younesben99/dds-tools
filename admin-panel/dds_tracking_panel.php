...
class DigiflowSettings {
    ...
    public function digiflow_settings_page_init() {
        ...
        add_settings_field(
            'show_keyword_loc_physical', // id
            'Show Keyword and Loc_physical', // title
            array($this, 'show_keyword_loc_physical_callback'), // callback
            'digiflow-settings-admin', // page
            'digiflow_settings_setting_section' // section
        );
    ...
    public function digiflow_settings_sanitize($input) {
        ...
        if (isset($input['show_keyword_loc_physical'])) {
            $sanitary_values['show_keyword_loc_physical'] = sanitize_text_field($input['show_keyword_loc_physical']);
        }
    ...
    // Add the new callback for the checkbox
    public function show_keyword_loc_physical_callback() {
        $checked = '';
        if (isset($this->digiflow_settings_options['show_keyword_loc_physical']) && $this->digiflow_settings_options['show_keyword_loc_physical'] == "1") {
            $checked = "checked";
        }
        echo('<input type="checkbox" id="show_keyword_loc_physical" name="digiflow_settings_option_name[show_keyword_loc_physical]" value="1" ' . $checked . '><label for="show_keyword_loc_physical"> Show Keyword and Loc_physical fields</label>');
    }
